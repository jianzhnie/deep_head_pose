...
class MultiNet(nn.Module):
    """
    Multinet with multi output layers for yaw, pitch and roll, form corse to fine.
    ...
    def __init__(self, block, layers, num_bins):
        ...
        self.fc_yaw_1 = nn.Linear(512 * block.expansion, 66)
        self.fc_yaw_2 = nn.Linear(512 * block.expansion, 18)
